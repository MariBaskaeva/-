...
public class main{
	...
	static void task1(){
    	MyDeque<String> deque1 = new MyDeque<String>();
    	MyDeque<String> deque2 = new MyDeque<String>();
    ...
    static void help1(String trueLine, MyDeque<String> deque1, MyDeque<String> deque2){
    ...
    static void hanoi_tower(MyStack<Integer> A, MyStack<Integer> B, MyStack<Integer> C, int n){
    	if(n <= 0){
    		return;
    	}
